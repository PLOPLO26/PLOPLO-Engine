...
//        return hr;
    ...
    */
    ...
    g_vertexBuffer.init(g_device, mesh, D3D11_BIND_VERTEX_BUFFER);
    ...
    mesh.numVertex = mesh.index.size();

    g_indexBufffer.init(g_device, mesh, D3D11_BIND_INDEX_BUFFER);
